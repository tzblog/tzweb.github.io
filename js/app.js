...
(function ($) {
  ...
  function setScrollAnchor() {
    ...
    if ($coverAnchor[0]) {
      if (
        enableCover == "true" &&
        $(".cover-wrapper#half").css("display") !== "none"
      )
        // Pjax 处理
  ...
  function setSearchService() {
    var SearchServiceimagePath =
      "https://cdn.jsdelivr.net/gh/volantis-x/cdn-volantis@master/img/";
...
$.extend({
  message: function (e) {
    ...
    "string" == typeof e && (n.message = e),
      "object" == typeof e && (n = $.extend({}, n, e));
    var i,
      o,
      s,
      t = n.showClose ? '<div class="c-message--close">×</div>' : "",
      a =
        "" !== n.title
          ? '<h2 class="c-message__title">' + n.title + "</h2>"
          : "",
      c =
    ...
    (o = function () {
      ...
      (s = function () {
        d.remove(), n.onClose(n), clearTimeout(i);
      }),
      $(".c-message").remove(),
      m.append(d),
      d.one(
      ...
      m.one("click", ".c-message--close", function (e) {
        o();
      }),
      n.autoClose &&
